...
void main() {
  group('Mock Authentication', () {
    ...
    test("Cannot log out you if not initialized", () {
      expect(
        provider.logOut(),
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    if (!isInitialized) throw NotInitializedException();
    if (email == "smsourov@bd.com") throw UserNotFoundAuthException();
    if (password == "summertimeproject") throw WrongPasswordAuthException();
